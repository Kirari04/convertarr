...
func History(Ctx t.TemplCtx, Title string, histories []m.History) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Var2 := templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
			...
			ctx = templ.InitializeContext(ctx)
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 1, "<article class=\"message\"><div class=\"message-header\"><p>History</p><form action=\"/scanner\" method=\"post\"><button type=\"submit\" class=\"button is-primary\">Scann Folders Now</button></form></div><div class=\"message-body\"><h2 class=\"subtitle is-4\">Encoding History</h2>")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			if len(histories) == 0 {
				templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 2, "<div class=\"field\">No files encodet yet</div>")
				if templ_7745c5c3_Err != nil {
					return templ_7745c5c3_Err
				}
			} else {
				templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 3, "<div id=\"refreshDiv\" hx-get=\"/history/table\" hx-trigger=\"every 2s[shouldRefresh()]\">")
				if templ_7745c5c3_Err != nil {
					return templ_7745c5c3_Err
				}
