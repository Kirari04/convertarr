	...
	return templ.ComponentFunc(func(ctx context.Context, templ_7745c5c3_W io.Writer) (templ_7745c5c3_Err error) {
		...
		for _, history := range histories {
			...
			case "probe":
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `components/HistoryTable.templ`, Line: 65, Col: 50}
				}
			...
			case "failed":
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `components/HistoryTable.templ`, Line: 67, Col: 52}
				}
			...
			case "finished":
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `components/HistoryTable.templ`, Line: 69, Col: 53}
				}
			...
			default:
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `components/HistoryTable.templ`, Line: 71, Col: 42}
				}
			...
			if history.Status == "failed" {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `components/HistoryTable.templ`, Line: 87, Col: 45}
				}
